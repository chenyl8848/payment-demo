...
/**
 * @author cyl
 * @date 2022-12-04 10:37
 * @description
 */
public class WechatPay2ValidatorUtil {

    protected static final Logger log = LoggerFactory.getLogger(WechatPay2ValidatorUtil.class);
    /**
     * 应答超时时间，单位为分钟
     */
    ...
    public WechatPay2ValidatorUtil(Verifier verifier, String requestId, String body) {
